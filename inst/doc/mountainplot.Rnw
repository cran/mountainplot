% mountainplot.Rnw
% Time-stamp: <05 Jun 2015 09:51:36 c:/x/rpack/mountainplot/vignettes/mountainplot.Rnw>
...
Monti (1995) suggestys that a mountain plot is helpful with exploring data and
makes it easier to:
\begin{enumerate}
...
\url{http://dx.doi.org/10.1016/j.spl.2011.03.014}
